	...
	public static String getTimeStamp(Resources res, Date creationDate) {
		if (creationDate != null) {
			...
			switch (unit) {
				...
				case MINUTES:
					return String.valueOf((int)(l/Constants.TIME_UNIT_MINUTE)) + "m";
				case HOURS:
					return String.valueOf((int)(l/Constants.TIME_UNIT_HOUR)) + "h";
				case DAYS:
					return String.valueOf((int)(l/Constants.TIME_UNIT_DAY)) + "d";
				case WEEKS:
					return String.valueOf((int)(l/Constants.TIME_UNIT_WEEK)) + "w";
				case MONTHS:
					return String.valueOf((int)(l/Constants.TIME_UNIT_MONTH)) + "mo";
				case YEARS:
					return String.valueOf((int)(l/Constants.TIME_UNIT_YEAR)) + "y";
