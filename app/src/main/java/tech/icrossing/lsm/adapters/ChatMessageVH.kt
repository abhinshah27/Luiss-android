...
import tech.icrossing.lsm.activities_and_fragments.activities_home.VideoViewActivityExoAuto
...
import tech.icrossing.lsm.utility.helpers.WebLinkRecognizer
import tech.icrossing.lsm.utility.realm.RealmUtils
import tech.icrossing.lsm.widgets.PlayerViewNoController
import tech.icrossing.lsm.widgets.RoundedCornersBackgroundSpan
import java.io.File
import java.util.*
...
//        }
    ...
    private fun openFullScreenActivity() {
        ...
        fragment.startActivityForResult(
                Intent(context, VideoViewActivityExoAuto::class.java).let {
                    it.putExtra(Constants.EXTRA_PARAM_1, currentMessage?.mediaURL)
