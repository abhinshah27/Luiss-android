...
import tech.icrossing.lsm.activities_and_fragments.activities_chat.ChatMessagesFragment
import tech.icrossing.lsm.activities_and_fragments.activities_chat.ChatRoomsFragment
import tech.icrossing.lsm.activities_and_fragments.activities_home.timeline.InteractionsViewerActivity
import tech.icrossing.lsm.activities_and_fragments.activities_home.timeline.TimelineFragment
import tech.icrossing.lsm.base.BaseSingletonWithArgument
import tech.icrossing.lsm.base.HLActivity
import tech.icrossing.lsm.base.LUISSApp
import tech.icrossing.lsm.models.*
import tech.icrossing.lsm.models.chat.ChatMessage
import tech.icrossing.lsm.models.chat.ChatRecipientStatus
import tech.icrossing.lsm.models.chat.ChatRoom
import tech.icrossing.lsm.notifications.FCMMessagingService
import tech.icrossing.lsm.services.HandleChatCreationService
import tech.icrossing.lsm.services.HandlePushedDataService
import tech.icrossing.lsm.utility.*
import tech.icrossing.lsm.utility.realm.RealmUtils
import tech.icrossing.lsm.websocket_connection.*
import java.util.*
            ...
            if (listenerChat != null) {
                when (listenerChat) {
                    is ChatRoomsFragment -> {
                        ...
                        if (LUISSApp.canVibrate) vibrateForChat(mContext)
...
//        }
    ...
    private fun callSetDataRead() {
        ...
        if (mContext is HLActivity)
            HLRequestTracker.getInstance((mContext as HLActivity).application as LUISSApp)
