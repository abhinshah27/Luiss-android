...
package tech.icrossing.lsm.utility.realm;
...
public class RealmUtils {
	...
	public static void closeRealm(Realm realm) {
		if (realm != null) {
			realm.close();
			LUISSApp.openRealms.remove(realm);
		}
	}

	public static void closeAllRealms() {
		if (LUISSApp.openRealms != null && !LUISSApp.openRealms.isEmpty()) {
			for (Realm realm : LUISSApp.openRealms) {
				try {
