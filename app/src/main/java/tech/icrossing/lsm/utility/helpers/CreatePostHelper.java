...
import tech.icrossing.lsm.activities_and_fragments.activities_create_post.AudioRecordFragment;
import tech.icrossing.lsm.activities_and_fragments.activities_create_post.CreatePostPreviewActivity;
import tech.icrossing.lsm.activities_and_fragments.activities_create_post.GalleryFragment;
import tech.icrossing.lsm.activities_and_fragments.activities_create_post.InitiativesFragment;
import tech.icrossing.lsm.activities_and_fragments.activities_create_post.PostVisibilityActivity;
import tech.icrossing.lsm.activities_and_fragments.activities_create_post.TagFragment;
import tech.icrossing.lsm.activities_and_fragments.activities_home.HomeActivity;
import tech.icrossing.lsm.activities_and_fragments.activities_home.wishes.WishCreatePostFragment;
import tech.icrossing.lsm.adapters.BasicAdapterInteractionsListener;
import tech.icrossing.lsm.adapters.CustomGalleryAdapter;
import tech.icrossing.lsm.adapters.SearchAdapter;
import tech.icrossing.lsm.adapters.TagAdapter;
...
import tech.icrossing.lsm.models.HLWebLink;
import tech.icrossing.lsm.models.Initiative;
import tech.icrossing.lsm.models.Interest;
import tech.icrossing.lsm.models.MemoryMediaObject;
import tech.icrossing.lsm.models.MemoryMessageObject;
import tech.icrossing.lsm.models.Post;
import tech.icrossing.lsm.models.PostPrivacy;
import tech.icrossing.lsm.models.PostVisibility;
...
import tech.icrossing.lsm.services.DeleteTempFileService;
import tech.icrossing.lsm.services.GetConfigurationDataService;
import tech.icrossing.lsm.utility.Constants;
import tech.icrossing.lsm.utility.DialogUtils;
import tech.icrossing.lsm.utility.FlingGestureListener;
...
import tech.icrossing.lsm.widgets.HLViewPagerNoScroll;
import tech.icrossing.lsm.widgets.PlayerViewNoController;
...
public class CreatePostHelper implements View.OnClickListener,
		...
		BasicAdapterInteractionsListener, SearchAdapter.OnItemClickListener,
		TagAdapter.OnItemClickListener, WebLinkRecognizer.LinkRecognitionListener {
...
//				Toast.makeText(activity, "Go to identity selection", Toast.LENGTH_SHORT).show();
	...
	private void attemptSendingPost() {
		...
		HLRequestTracker.getInstance(((LUISSApp) activity.getApplication())).handleCallResult(this, activity, results);
	}
	...
	private void callForLinkParsing(String link) {
		if (link != null) {
			...
			if (Utils.isContextValid(activity)) {
				HLRequestTracker.getInstance(((LUISSApp) activity.getApplication()))
			...
			case AUDIO:
				...
				if (bck != null) {
					...
					if (siriComposition == null)
						siriComposition = LUISSApp.siriComposition;
