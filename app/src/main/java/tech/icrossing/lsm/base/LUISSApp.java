package tech.icrossing.lsm.base;
...
import tech.icrossing.lsm.services.LocationUpdateService;
import tech.icrossing.lsm.utility.Constants;
import tech.icrossing.lsm.utility.LogUtils;
import tech.icrossing.lsm.utility.RingerChangedReceiver;
...
import tech.icrossing.lsm.utility.realm.LUISSMigration;
import tech.icrossing.lsm.utility.realm.RealmUtils;
import tech.icrossing.lsm.websocket_connection.HLSocketConnection;

/**
 * @author mbaldrighi on 9/1/2017.
 */
public class LUISSApp extends MultiDexApplication implements OnApplicationContextNeeded {

	public static final String LOG_TAG = LUISSApp.class.getCanonicalName();
...
//			@Override
//			public void run() {
//				LottieCompositionFactory.Factory.fromAssetFileName(LUISSApp.this, "siri.json",
...
//					if (Utils.isServiceRunning(LUISSApp.this, LocationUpdateService.class))
//						LocationUpdateService.startService(LUISSApp.this, null, LocationUpdateService.GroundType.BACKGROUND);
				...
				public void onBecameBackground() {
					...
					if (SharedPrefsUtils.hasLocationBackgroundBeenGranted(LUISSApp.this) &&
							Utils.hasApplicationPermission(LUISSApp.this, Manifest.permission.ACCESS_FINE_LOCATION)) {
						LocationUpdateService.startService(LUISSApp.this, null, LocationUpdateService.GroundType.FOREGROUND);
					}
...
//						LocationUpdateService.startService(LUISSApp.this, null, LocationUpdateService.GroundType.FOREGROUND);
	...
	public void setSiriComposition(LottieComposition siriComposition) {
		LUISSApp.siriComposition = siriComposition;
	}
