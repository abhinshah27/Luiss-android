...
package tech.icrossing.lsm.voiceVideoCalls
...
import tech.icrossing.lsm.voiceVideoCalls.tmp.ACTION_MAIN
import tech.icrossing.lsm.voiceVideoCalls.tmp.VoiceVideoCallType
import tech.icrossing.lsm.voiceVideoCalls.tmp.VoiceVideoUsageType
...
//                    this.addAction(NotificationCompat.Action.Builder(0, "Mute", mutePending).build())
            ...
            NotificationType.MISSED_CALL -> {
                val appIntent = Intent(this, if (LUISSApp.isForeground) HomeActivity::class.java else SplashActivity::class.java)
