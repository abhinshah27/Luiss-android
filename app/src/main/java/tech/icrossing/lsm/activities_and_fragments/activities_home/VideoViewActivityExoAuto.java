 ...
 */
public class VideoViewActivityExoAuto extends HLActivity
		implements /*AudioManager.OnAudioFocusChangeListener,*/ Player.EventListener,
		ShareHelper.ShareableProvider {

	public static final String LOG_TAG = VideoViewActivityExoAuto.class.getCanonicalName();
...
//				}
//				else {
//					MediaHelper.loadPictureWithGlide(VideoViewActivityExoAuto.this, thumbnail, mThumbnailView);
