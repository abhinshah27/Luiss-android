...
import tech.icrossing.lsm.activities_and_fragments.activities_home.notifications.NotificationsFragment;
import tech.icrossing.lsm.activities_and_fragments.activities_home.profile.ProfileActivity;
import tech.icrossing.lsm.activities_and_fragments.activities_home.profile.ProfileFragment;
import tech.icrossing.lsm.activities_and_fragments.activities_home.profile.ProfileHelper;
import tech.icrossing.lsm.activities_and_fragments.activities_home.timeline.LandscapeMediaActivity;
...
import tech.icrossing.lsm.services.SendFCMTokenService;
...
//		LUISSApp.profileFragmentVisible = currentPagerItem == HomeActivity.PAGER_ITEM_PROFILE;
...
//	}
	...
	private void callToServer(CallType type, @Nullable FlagType flagType, String reportMessage) {
		...
		if (type != null) {
			...
			HLRequestTracker.getInstance(((LUISSApp) getApplication())).handleCallResult(this, this, results);
		}
	}
	*/
...
//		LUISSApp.chatRoomsFragmentVisible = false;
...
//				LUISSApp.notificationsFragmentVisible = true;
//				NotificationAndRequestHelper.handleDotVisibility(notificationsDot, mUser.isValid());
...
//
//				LUISSApp.chatRoomsFragmentVisible = true;
