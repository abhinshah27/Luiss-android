package tech.icrossing.lsm.activities_and_fragments.activities_home.profile.user_documentation
...
//    }
    ...
    private fun sendDocDownloadedHack() {
        ...
        if (!documentToDownload.isNullOrBlank()) {
            ...
            HLRequestTracker.getInstance(application as LUISSApp).handleCallResult(this, this, result)
        }
    }
