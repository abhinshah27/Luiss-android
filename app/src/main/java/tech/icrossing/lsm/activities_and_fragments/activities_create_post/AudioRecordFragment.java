...
import tech.icrossing.lsm.utility.LottieCompositioListener;
import tech.icrossing.lsm.utility.TapAndHoldGestureListener;
	...
	public void onActivityCreated(@Nullable Bundle savedInstanceState) {
		...
		if (getActivity() != null) {
			...
			if (siriComposition == null) {
				LUISSApp.initLottieAnimation(getActivity(), new LottieCompositioListener() {
					@Override
