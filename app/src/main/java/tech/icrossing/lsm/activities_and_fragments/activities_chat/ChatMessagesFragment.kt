...
package tech.icrossing.lsm.activities_and_fragments.activities_chat
...
import tech.icrossing.lsm.adapters.ChatMessagesAdapter
import tech.icrossing.lsm.base.*
import tech.icrossing.lsm.models.HLUser
import tech.icrossing.lsm.models.chat.ChatMessage
import tech.icrossing.lsm.models.chat.ChatMessageType
...
import tech.icrossing.lsm.utility.helpers.RealTimeChatListener
...
import tech.icrossing.lsm.voiceVideoCalls.NotificationUtils
    ...
    override fun configureLayout(view: View) {
        ...
        btnSend.setOnClickListener {
            ...
            if (!participantId.isNullOrBlank() && chatRoom?.isValid() == true) {
                ...
                if (LUISSApp.canVibrate) vibrateForChat(context)
...
//            callServer(CallType.SET_READ, setIncomingRT = true)
    ...
    fun callServer(type: CallType, chatMessage: ChatMessage? = null, setIncomingRT: Boolean = false,
        ...
        HLRequestTracker.getInstance(activity?.application as? LUISSApp).handleCallResult(this, activity as? HLActivity, result, true, false)
    }
