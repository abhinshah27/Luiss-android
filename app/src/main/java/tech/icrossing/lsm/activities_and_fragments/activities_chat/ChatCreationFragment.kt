...
import tech.icrossing.lsm.adapters.ChatCreationAdapterDiff
import tech.icrossing.lsm.adapters.HLUserGenericDiffCallback
...
class ChatCreationFragment:
    ...
    private fun callServer(type: CallType, room: ChatRoom? = null) {
        ...
        HLRequestTracker.getInstance(activity?.application as? LUISSApp).handleCallResult(this, activity as? HLActivity, result, true, true)
    }
