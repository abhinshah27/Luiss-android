...
import tech.icrossing.lsm.adapters.LegacyContactAdapter;
...
public class LegacyContactSelectionActivity extends HLActivity implements View.OnClickListener,
		...
		SearchHelper.OnQuerySubmitted, SearchAdapter.OnItemClickListener, BasicAdapterInteractionsListener {
...
//					fromLoadMore = false;
	...
	private void callServer(CallType type, String legacyId) {
		...
		HLRequestTracker.getInstance((LUISSApp) getApplication())
