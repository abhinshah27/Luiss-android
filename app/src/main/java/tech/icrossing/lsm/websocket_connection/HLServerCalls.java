...
import tech.icrossing.lsm.activities_and_fragments.activities_home.profile.UserDetailFragment;
import tech.icrossing.lsm.activities_and_fragments.activities_home.settings.SettingsAccountFragment;
import tech.icrossing.lsm.activities_and_fragments.activities_home.settings.SettingsICSingleCircleFragment;
import tech.icrossing.lsm.activities_and_fragments.activities_home.settings.SettingsICTimelineFeedFragment;
import tech.icrossing.lsm.activities_and_fragments.activities_home.settings.SettingsPrivacySelectionFragment;
import tech.icrossing.lsm.activities_and_fragments.activities_home.settings.SettingsSecurityLegacy2StepFragment;
import tech.icrossing.lsm.activities_and_fragments.activities_home.settings.SettingsSecurityLegacyContactTriggerFragment;
import tech.icrossing.lsm.activities_and_fragments.activities_login.LoginActivity;
import tech.icrossing.lsm.base.HLActivity;
import tech.icrossing.lsm.base.LUISSApp;
import tech.icrossing.lsm.models.FamilyRelationship;
import tech.icrossing.lsm.models.GenericUserFamilyRels;
import tech.icrossing.lsm.models.HLCircle;
import tech.icrossing.lsm.models.HLInterestAbout;
import tech.icrossing.lsm.models.HLNotifications;
import tech.icrossing.lsm.models.HLUser;
import tech.icrossing.lsm.models.HLUserAboutMe;
import tech.icrossing.lsm.models.HLUserAboutMeMore;
import tech.icrossing.lsm.models.HLUserGeneric;
import tech.icrossing.lsm.models.InteractionComment;
import tech.icrossing.lsm.models.InteractionHeart;
import tech.icrossing.lsm.models.InteractionPost;
import tech.icrossing.lsm.models.InteractionShare;
import tech.icrossing.lsm.models.LifeEvent;
import tech.icrossing.lsm.models.MarketPlace;
import tech.icrossing.lsm.models.MemoryMediaObject;
import tech.icrossing.lsm.models.MoreInfoObject;
import tech.icrossing.lsm.models.Notification;
import tech.icrossing.lsm.models.Post;
import tech.icrossing.lsm.models.ProfileContactToSend;
import tech.icrossing.lsm.models.SettingsHelpElement;
import tech.icrossing.lsm.models.WishEmail;
import tech.icrossing.lsm.models.WishListElement;
import tech.icrossing.lsm.models.enums.ActionTypeEnum;
import tech.icrossing.lsm.models.enums.NotificationTypeEnum;
import tech.icrossing.lsm.models.enums.PostTypeEnum;
import tech.icrossing.lsm.models.enums.PrivacyPostVisibilityEnum;
import tech.icrossing.lsm.models.enums.SearchTypeEnum;
import tech.icrossing.lsm.models.enums.UnBlockUserEnum;
...
public class HLServerCalls {
	...
	public static Object[] subscribeToSocket(final Context context, final String userId, boolean isChat) {
		if (isChat) {
			if (!LUISSApp.getSocketConnection().isConnectedChat())
				return resultsNotConnected();
		}
		else {
			if (!LUISSApp.getSocketConnection().isConnected())
				return resultsNotConnected();
		}
		...
		if (Utils.isStringValid(userId)) {
			...
			if (isChat) {
				if (!LUISSApp.subscribedToSocketChat) {
					LUISSApp.getSocketConnection().sendMessageChat(jsonResult[0]);
					LUISSApp.subscribedToSocketChat = true;
				}
			}
			else {
				if (!LUISSApp.subscribedToSocket) {
					LUISSApp.getSocketConnection().sendMessage(jsonResult[0]);
...
//	}
	 ...
	 * {@link tech.icrossing.lsm.activities_and_fragments.activities_home.profile.ProfileHelper.ProfileType#FRIEND}.
	 * @param interestIdToFetch must always refer to the {@link tech.icrossing.lsm.models.Interest} to be fetched.
...
//			return resultsNotConnected();
		...
		return new Object[] { LUISSApp.getSocketConnection().isConnected(), jsonResult[0], jsonResult[1] };
	}
...
//			return resultsNotConnected();
	...
	public static Object[] settingsOperationsOnFeedSettings(@NonNull String userId, @NonNull Bundle bundle,
		...
		if (!LUISSApp.getSocketConnection().isConnected() && type == SettingsICTimelineFeedFragment.CallType.SET)
			return resultsNotConnected();
	...
	public static Object[] settingsOperationsOnPrivacy(@NonNull String userId, int idItem,
		...
		if (!LUISSApp.getSocketConnection().isConnected() && type == SettingsPrivacySelectionFragment.CallType.SET)
			return resultsNotConnected();
...
//				if (Utils.isStringValid(queryString))
	...
	public static void doActionOnNotification(HLActivity activity, String notificationId, ActionTypeEnum type,
		...
		HLRequestTracker.getInstance(((LUISSApp) activity.getApplication())).handleCallResult(connectionListener, activity, result);
	}
